...
public class OfflineLocationService extends Service {
    ...
    public void onCreate() {
        ...
        Log.v("TAG","OfflineLocationService started");
    ...
    public class LocalBinder extends Binder {
        public OfflineLocationService getService() {
            // Return this instance of LocalService so clients can call public methods
            return OfflineLocationService.this;
        }
    }
        ...
        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER,
                ...
                0, new LocationListener() {
                    ...
                    public void onLocationChanged(@NonNull Location location) {
                        ...
                        mEditor.putString("mylat", String.valueOf(latitude));
                        mEditor.putString("mylong", String.valueOf(longitude));
                        mEditor.apply();
    ...
    private void CallApi_Of_add_LOcation(double lat, double lng) {
        ...
        if(pending_job_pref.getString("session_loggedin","0").equalsIgnoreCase("1")
            ...
            Log.i("DB","Updating db geofence task id "+pending_job_pref.getString("geofencetaskid",""));
